...
pub unsafe fn root_as_weather_api_response_unchecked(buf: &[u8]) -> WeatherApiResponse { unsafe {
...
pub unsafe fn size_prefixed_root_as_weather_api_response_unchecked(buf: &[u8]) -> WeatherApiResponse { unsafe {
